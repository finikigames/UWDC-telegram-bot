...
const start = () => {
    ...
    bot.on('message', function(msg, reply, next) {
        ...
        if (text === '/start') {
            ...
            \nЭто команда <a href="https://Finiki.games">Finiki.games</a>.
...
Сбор участников Лиги поддающихся джентльменов для розыгрыша призов  в Зале Galaxy 3 в 14.40.
Вручение призов всем участникам на стойке регистрации с 15.00 до 16.00.
    ...
    bot.on('callback_query', msg => {
        ...
        let gameurl = gameUrl+"?id="+msg.from.id+"0000"+"&first_name="+formatedName+"&last_name="+formatedLastName+"&username="+msg.from.username;
        console.log(gameurl);
