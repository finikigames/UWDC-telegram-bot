...
const start = () => {
    ...
    bot.on('message', function(msg, reply, next) {
        ...
        if (text === '/start') {
            ...
            \nСражайся, войди в топ-3, и забирай кайфовые призы: наушники Apple AirPods Pro 2, мощные акку>
...
function scheduleMesage(chatId) {
    setTimeout(function() {SendMessage(chatId);}, 7200000);
}

function SendMessage(chatId) {
    bot.sendMessage(chatId, `Спасибо за игру. Приходи 03.06.23 на конференцию UWDC. В 12:40 на стенде Infi>
    \nПодписывайся на телеграмм-канал о работе в Infinnity Solutions. Делимся профессиональным опытом, рас>
