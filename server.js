...
Главная цель игры — избавиться от всех своих фигур, подвергая их уничтожению противником.
            \nСражайся, войди в топ-5, и забирай кайфовые призы: звонкие портативные колонки и стильные термосы.
...
function SendByeMessage(chatId) {
    bot.sendMessage(chatId, `Привет, это <a href="https://Finiki.games">Finiki.games</a>! Рады были увидеться с тобой на Gamedev Weekend 2023 💕 Спасибо, что поучаствовал в онлайн-турнире.
